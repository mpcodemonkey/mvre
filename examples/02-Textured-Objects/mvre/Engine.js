    ...
    function onVRPresentChange () {
        ...
        if (vrDisplay.isPresenting) {
            if (vrDisplay.capabilities.hasExternalDisplay) {
                ...
                vrPresentButton = VRSamplesUtil.addButton("Exit VR", "E", "mvre/third-party/media/icons/cardboard64.png", onVRExitPresent);
            }
        } else {
            ...
            if (vrDisplay.capabilities.hasExternalDisplay) {
                ...
                VRSamplesUtil.removeButton(vrPresentButton);
                vrPresentButton = VRSamplesUtil.addButton("Enter VR", "E", "mvre/third-party/media/icons/cardboard64.png", onVRRequestPresent);
            }
        }
    }
